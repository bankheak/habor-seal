...
Negative binomial or poisson would be the best fit. Let's check if the mean is equal to the variance.

```{r vartomean, echo=TRUE}
var(full.data$seals)
...
The variance is way higher than the mean which was confirmed by the Pearson chi-squared test, therefore the Poisson distribution is not applicable here and we will continue with the negative binomial distribution.
